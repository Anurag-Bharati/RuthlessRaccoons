...
public class ResizeHelper {
    ...
    static class ResizeListener implements EventHandler<MouseEvent> {
        ...
        public void handle(MouseEvent mouseEvent) {
            ...
            } else if (MouseEvent.MOUSE_PRESSED.equals(mouseEventType) && !stage.isMaximized())  {
            ...
            if (MouseEvent.MOUSE_PRESSED.equals(mouseEventType) && Cursor.DEFAULT.equals(cursorEvent)  && !stage.isMaximized()) {
                resizing = false;
            ...
            if (MouseEvent.MOUSE_DRAGGED.equals(mouseEventType) && Cursor.DEFAULT.equals(cursorEvent) && resizing == false  && !stage.isMaximized()) {
